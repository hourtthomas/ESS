 ...
 */
class Etage extends \App\Entity\Etage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Etage' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Etage' . "\0" . 'denomination', '' . "\0" . 'App\\Entity\\Etage' . "\0" . 'rapports'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Etage $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setDenomination(string $denomination): \App\Entity\Etage
    {
     ...
     * {@inheritDoc}
     */
    public function addRapport(\App\Entity\Rapport $rapport): \App\Entity\Etage
    {
     ...
     * {@inheritDoc}
     */
    public function removeRapport(\App\Entity\Rapport $rapport): \App\Entity\Etage
    {
